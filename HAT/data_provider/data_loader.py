...
class Dataset_M4(Dataset):
    ...
    def __getitem__(self, index):
        ...
        print(sampled_timeseries.shape)
        # print(sampled_timeseries)
        ...
        # print(insample_window)
        print(insample_window.shape)
        ...
        print('insample_mask')
        # print(insample_mask)
        print(insample_mask.shape)
        outsample_window = sampled_timeseries[
                           cut_point - self.label_len:min(len(sampled_timeseries), cut_point + self.pred_len)]
        print('outsample_window')
        # print(outsample_window)
        print(outsample_window.shape)
